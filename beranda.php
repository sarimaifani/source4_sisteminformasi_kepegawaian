    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di SIK Dinas Pertanian Kabupaten Asahan</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Arsip Data Pegawai</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th><center>Id Pegawai</center></th><th width="30%">Nama Pegawai</th><th>No.Hp</th><th>Email</th><th>Jabatan</th>
                            </tr>
                        </thead>
                        <tbody>
